...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 11380000 * COIN;
    }
		else if(pindexBest->nHeight < 43200)
    {
		nSubsidy = 25 * COIN;
    }
    	else if(pindexBest->nHeight < 43500)
	{
		nSubsidy = 0 * COIN;
	}
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BoomCoin10312014";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0246bfde4cbd776cca770a8309dbb870e33f0784e1f26af577c4cac5961cf03a"));
        block.print();
